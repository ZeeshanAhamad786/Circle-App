...
RichText(text: TextSpan(children: [
  ...
  TextSpan(text: 'Winter Trip Plan:',style: CustomTextStyle.buttonText.copyWith(color: Colors.white,fontSize: 12.px)),
        ...
        Text('''Lorem ipsum dolor sit amet consectetur. Eget aliquam suspendisse ultrices a mattis vitae. Adipiscing id vestibulum ultrices lorem. Nibh dignissim bibendum aAdipi.''',style: CustomTextStyle.hintText,),
            getVerticalSpace(1.2.h),
            Text('Images',style: CustomTextStyle.headingStyle.copyWith(color: Colors.white),),
