            ...
            children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.person_add_sharp,color: CustomColor.mainColorYellow,),
                    ...
                    itemBuilder: (BuildContext ,index){
                      ...
                      return GestureDetector(onTap: () {
                        ...
                        child: Container(
                          ...
                          child: ListTile(
                            title: Text(items[index].title,style: CustomTextStyle.mediumTextTitle,),
                            ...
                            trailing: Column(
                              ...
                              children: [
                                Text(items[index].time,style: CustomTextStyle.mediumTextTime,),
                                ...
                                Container(
                                  ...
                                  decoration:  BoxDecoration(
                                      ...
                                      color:  CustomColor.mainColorYellow)),
                                  child:Center(child: Text("12",style: CustomTextStyle.mediumTextNumber,))
                                ),
                              ],
                            ),
