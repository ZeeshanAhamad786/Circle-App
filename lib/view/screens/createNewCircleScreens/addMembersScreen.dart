...
class _AddMembersState extends State<AddMembers> {
  ...
  Widget build(BuildContext context) {
    ...
    String interest = arguments['interest'] ?? '';

    // print("All Data Create Circle: $name, $description, $type, $imageUrl, $interest, $selectionMembersList");
    print('selected items: ${selectionMembersList.length}');
    return Obx(
      () => Scaffold(
                              ...
                              return Obx(() => Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        ...
                                        print(
                                            "Selected items: ${selectionMembersList.join(', ')}");
                                      },
                                      child: Container(
