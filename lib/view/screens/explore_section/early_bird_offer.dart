...
class _EarlyBirdOfferState extends State<EarlyBirdOffer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: CustomColor.mainColorBackground,
        ...
        children: [
          GestureDetector(onTap:() {
            Get.back();
              ...
              child: Icon(Icons.arrow_back_ios_new,color: Colors.white,size: 19.px,)),
          getHorizentalSpace(4.w),
          Text("Early Bird Offer",style: CustomTextStyle.mediumTextExplore,),
        ],
      ),
        actions: [SvgPicture.asset("assets/svg/shareIcon.svg",),
          getHorizentalSpace(2.w),
          Container(
            height: 22.px,width: 20.w,
        ...
        child: SingleChildScrollView(
         ...
         Obx(()=> Column(children: [
           AnimatedContainer(duration: Duration(milliseconds: 300),
               ...
               child: Image.asset(largeImage.value,fit: BoxFit.cover,)),
getVerticalSpace(1.h),
           ...
           Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
             children: [
               Text("Imagine Dragon’s Concert",style: CustomTextStyle.mediumTextImageConcert,),
               SvgPicture.asset("assets/svg/save.svg")
             ],
           ),
           getVerticalSpace(0.5.h),
           Text("""Lorem ipsum dolor sit amet consectetur. Eget aliquam suspendisse ultrices a\n mattie. Adipiscing id vestibulum ultrices lorem. Nibh dignissim bibendum"""
             ,style: TextStyle(
           ...
           getVerticalSpace(1.h),
           Row(children: [
             Text("Offer for",  style: TextStyle(
                 color: Colors.white.withOpacity(0.5),
                 fontSize: 11.px,
                 fontWeight: FontWeight.w400,
                 fontFamily: "medium"),),
             getHorizentalSpace(0.5.w),
             Text("5 People",style:  CustomTextStyle.mediumTextM,),
           ],),
           getVerticalSpace(1.h),
           Row(children: [
             Text("Interest",style: TextStyle(
                 ...
                 fontFamily: "medium"),),
             getHorizentalSpace(0.5.w),
             Text("Music",style:  CustomTextStyle.mediumTextM,),
           ],),
           getVerticalSpace(1.h),
           Row(children: [
             Text("Total Price:",style: TextStyle(
                 ...
                 fontFamily: "medium"),),
             getHorizentalSpace(0.5.w),
             Text("\$2500",style:  CustomTextStyle.mediumTextM,),
             Expanded(child: SizedBox()),
             Text("10/07/2024" ,style: TextStyle(
                 color: Colors.white.withOpacity(0.7),
                 fontSize: 11.px,
                 fontWeight: FontWeight.w400,
                 fontFamily: "medium"),)
