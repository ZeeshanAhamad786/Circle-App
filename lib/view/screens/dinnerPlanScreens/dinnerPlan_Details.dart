      ...
      body: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          ...
          ListView.builder(padding: EdgeInsets.zero,
            ...
            return Container(margin: EdgeInsets.symmetric(vertical: .5.h),
            ...
            child:   Row(
              children: [
                Text(statusList[index],style: CustomTextStyle.headingStyle,),
                const Expanded(child: SizedBox()),
                Text( paymentList[index],style: CustomTextStyle.smallText.copyWith(color: index==1?const Color(0xff79F966):index==2?const Color(0xffFF881A):const Color(0xffF8F8F8))),

              ],
            ),);
          },),
          getVerticalSpace(2.3.h),
          Text('Pending Amount',style: CustomTextStyle.headingStyle.copyWith(color: Colors.white),),
            getVerticalSpace(1.h),

            GestureDetector(
              onTap: () {
                Get.to(()=>const PaymentScreen(title: 'dinnerPlan',));
              },
                    ...
                    child:   Row(
                      children: [
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:  const Color(0xff00B332)
                        ),
                        child: Text('Pay',style: CustomTextStyle.buttonText.copyWith(color: Colors.white,fontSize: 10.px),),)
            ...
            Text('Paid Amount',style: CustomTextStyle.headingStyle.copyWith(color: Colors.white),),
            getVerticalSpace(1.h),
                  ...
                  child:   Row(
                    children: [
                      ...
                      Container(alignment: Alignment.center,
                        ...
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(5.px),
                            color:  const Color(0xff00B332).withOpacity(0.5)
                        ),
                        child: Text('Pay',style: CustomTextStyle.buttonText.copyWith(color: Colors.white.withOpacity(0.5),fontSize: 10.px),),)
...
getVerticalSpace(2.h),
            Text('Added person',style: CustomTextStyle.headingStyle.copyWith(color: Colors.white),),
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemExtent: 5.h,
                itemBuilder: (context, index) {
                  return Container(margin: EdgeInsets.symmetric(horizontal: .3.h),
                    decoration: BoxDecoration(
                        border: Border.all(
            ...
            getVerticalSpace(2.h),
            Text('Bill receipt',style: CustomTextStyle.headingStyle.copyWith(color: Colors.white),),
            getVerticalSpace(1.h),
            SizedBox(
              height: 4.h,
              child: ListView.builder(
